    ...
    <div className="h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Link href="/cart" passHref>
          <Popover.Button className="h-full">{<FaShoppingCart className="icon d-flex justify-content-center flex-row  mr-16" />}
          <span className="total">{totalItems}</span></Popover.Button>
        </Link>
        <Transition
          show={state}
          as={Fragment}
        ...
        >
          ...
          >
            <div className="p-4 flex items-center justify-center">
              <h3 className="text-large-semi">სავაჭრო კალათი</h3>
            </div>
            {cart && items?.length ? (
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular">
                  ...
                  <Link href="/cart" passHref>
                    <a>
                      <Button>
                        <span className="text-lg">შეკვეთის გაგრძელება</span></Button>
                    </a>
                  </Link>
                </div>
              </>
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  ...
                  <span className="text-base">თქვენი სავაჭრო კალათა ცარიელია.</span>
                  <div>
                    <Link href="/store">
                      <a>
                        <span className="sr-only">გადადი პროდუქტების გვერდზე</span>
                        <Button onClick={close}>
                          <span className="text-lg">ყველა პროდუქტი</span>
                        </Button>
                      </a>
                    </Link>
                  </div>
