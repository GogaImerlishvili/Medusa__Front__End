...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">მიწოდება</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">მისამართი</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">მიწოდების მეთოდი</h3>
        <div>
